...
- pgTAP/RLS local: bloqueado porque o Postgres local em `127.0.0.1:54322` não estava ativo; os testes SQL foram criados e precisam rodar em ambiente Supabase disponível antes de declarar a migration validada em produção.
